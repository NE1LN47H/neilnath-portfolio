      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-3xl mx-auto">
          <p className="text-lg mb-6">
            I'm a passionate developer and ethical hacker, dedicated to building secure and efficient solutions. 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
            <div className="p-6 bg-tech-black rounded-lg border border-tech-red/20">
              <h3 className="text-xl font-semibold mb-4 text-tech-red">Developer</h3>
            ...
            <div className="p-6 bg-tech-black rounded-lg border border-tech-red/20">
              ...
              <p className="text-gray-300">
                ...
                Passionate to help organizations strengthen their security posture.
              </p>
            </div>
          </div>
        </div>
